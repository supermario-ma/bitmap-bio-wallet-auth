...
// Never hand the wallet a message we have not checked ourselves. The server
// is trusted, but a tampered response, a mis-routed proxy or a stale
// deployment must not be able to choose what the user signs.
